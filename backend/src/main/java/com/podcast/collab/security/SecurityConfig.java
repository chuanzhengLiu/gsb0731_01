...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/share/token/**").permitAll()
    ...
    @Bean
    public static RateLimitingFilter rateLimitingFilter(
        ...
        return new RateLimitingFilter(loginLimit, uploadLimit, generalLimit, objectMapper);
    }
